...
public class BungeeGroup implements Group {
    ...
    public BungeeGroup(String name, List<String> parents, int priority, List<CommandCompleter> tabcomplete, AdvancedPlHideBungee core) {
        this.name = name;
    ...
    public static Group forPlayer(ProxiedPlayer player) {
