...
package tk.bluetree242.advancedplhide.velocity.impl.group;
...
public class VelocityGroup implements Group {
    ...
    public VelocityGroup(String name, List<String> parents, int priority, List<CommandCompleter> tabcomplete, AdvancedPlHideVelocity core) {
        this.name = name;
