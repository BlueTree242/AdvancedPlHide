...
public class OfferCompleterList extends CommandCompleterList {
    private final List<TabCompleteResponsePacket.Offer> offers;
    private final boolean legacy;

    public OfferCompleterList(List<TabCompleteResponsePacket.Offer> offers, boolean legacy) {
        this.offers = offers;
        this.legacy = legacy;
        for (TabCompleteResponsePacket.Offer offer : offers) {
    ...
    public boolean remove(Object e) {
        ...
        for (TabCompleteResponsePacket.Offer offer : new ArrayList<>(offers)) {
            if (!legacy) {
