...
package dev.bluetree242.advancedplhide.velocity.impl.subcompleter;
...
public class OfferSubCommandCompleterList extends SubCommandCompleterList {
    private final List<TabCompleteResponsePacket.Offer> suggestions;
    private final String command;
    private final String[] args;

    public OfferSubCommandCompleterList(List<TabCompleteResponsePacket.Offer> suggestions, String notCompleted) {
        this.suggestions = suggestions;
        for (TabCompleteResponsePacket.Offer suggestion : suggestions) {
    ...
    @Override
    public List<TabCompleteResponsePacket.Offer> export() {
        return suggestions;
    }
    ...
    public boolean remove(Object e) {
        ...
        for (TabCompleteResponsePacket.Offer suggestion : new ArrayList<>(suggestions)) {
